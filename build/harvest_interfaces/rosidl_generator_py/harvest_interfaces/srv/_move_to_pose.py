...
class MoveToPose_Response(metaclass=Metaclass_MoveToPose_Response):
    ...
    _fields_and_field_types = {
        'result': 'boolean',
        'reverse_traj': 'std_msgs/Float32MultiArray',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float32MultiArray
        self.reverse_traj = kwargs.get('reverse_traj', Float32MultiArray())
    ...
    def __eq__(self, other):
        ...
        if self.result != other.result:
            return False
        if self.reverse_traj != other.reverse_traj:
            return False
        return True
    ...
    @builtins.property
    def reverse_traj(self):
        """Message field 'reverse_traj'."""
        return self._reverse_traj

    @reverse_traj.setter
    def reverse_traj(self, value):
        if __debug__:
            from std_msgs.msg import Float32MultiArray
            assert \
                isinstance(value, Float32MultiArray), \
                "The 'reverse_traj' field must be a sub message of type 'Float32MultiArray'"
        self._reverse_traj = value
...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'harvest_interfaces.srv.MoveToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from harvest_interfaces.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from harvest_interfaces.srv._move_to_pose import MoveToPose_Request as Request
    from harvest_interfaces.srv._move_to_pose import MoveToPose_Response as Response
