...
#ifndef HARVEST_INTERFACES__SRV__DETAIL__COORDINATE_TO_TRAJECTORY__FUNCTIONS_H_
#define HARVEST_INTERFACES__SRV__DETAIL__COORDINATE_TO_TRAJECTORY__FUNCTIONS_H_
...
/// Initialize srv/CoordinateToTrajectory message.
/**
...
/// Finalize srv/CoordinateToTrajectory message.
/**
...
/// Create srv/CoordinateToTrajectory message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Request__init().
...
/// Destroy srv/CoordinateToTrajectory message.
/**
 * It calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Request__fini()
...
/// Check for srv/CoordinateToTrajectory message equality.
/**
...
/// Copy a srv/CoordinateToTrajectory message.
/**
...
/// Initialize array of srv/CoordinateToTrajectory messages.
/**
...
/// Finalize array of srv/CoordinateToTrajectory messages.
/**
 * It calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Request__fini()
...
/// Create array of srv/CoordinateToTrajectory messages.
/**
 * It allocates the memory for the array and calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CoordinateToTrajectory messages.
/**
 * It calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CoordinateToTrajectory message array equality.
/**
...
/// Copy an array of srv/CoordinateToTrajectory messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_harvest_interfaces
...
/**
 * It calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_harvest_interfaces
...
/**
 * It allocates the memory for the array and calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_harvest_interfaces
...
/**
 * It calls
 * harvest_interfaces__srv__CoordinateToTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HARVEST_INTERFACES__SRV__DETAIL__COORDINATE_TO_TRAJECTORY__FUNCTIONS_H_
