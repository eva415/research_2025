...
harvest_interfaces__srv__RecordTopics_Request__init(harvest_interfaces__srv__RecordTopics_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->topics, 0)) {
    harvest_interfaces__srv__RecordTopics_Request__fini(msg);
    return false;
  }
  // file_name_prefix
  if (!rosidl_runtime_c__String__init(&msg->file_name_prefix)) {
    harvest_interfaces__srv__RecordTopics_Request__fini(msg);
    return false;
  }
  return true;
...
harvest_interfaces__srv__RecordTopics_Request__fini(harvest_interfaces__srv__RecordTopics_Request * msg)
{
  ...
  // file_name_prefix
  rosidl_runtime_c__String__fini(&msg->file_name_prefix);
}
...
harvest_interfaces__srv__RecordTopics_Request__are_equal(const harvest_interfaces__srv__RecordTopics_Request * lhs, const harvest_interfaces__srv__RecordTopics_Request * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->file_name_prefix), &(rhs->file_name_prefix)))
  {
    return false;
  }
  return true;
  ...
  harvest_interfaces__srv__RecordTopics_Request * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->file_name_prefix), &(output->file_name_prefix)))
  {
    return false;
  }
  return true;
...
harvest_interfaces__srv__RecordTopics_Request__create()
{
  ...
  harvest_interfaces__srv__RecordTopics_Request * msg = (harvest_interfaces__srv__RecordTopics_Request *)allocator.allocate(sizeof(harvest_interfaces__srv__RecordTopics_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(harvest_interfaces__srv__RecordTopics_Request));
  bool success = harvest_interfaces__srv__RecordTopics_Request__init(msg);
  if (!success) {
...
harvest_interfaces__srv__RecordTopics_Request__Sequence__init(harvest_interfaces__srv__RecordTopics_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  harvest_interfaces__srv__RecordTopics_Request * data = NULL;

  if (size) {
    data = (harvest_interfaces__srv__RecordTopics_Request *)allocator.zero_allocate(size, sizeof(harvest_interfaces__srv__RecordTopics_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = harvest_interfaces__srv__RecordTopics_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        harvest_interfaces__srv__RecordTopics_Request__fini(&data[i - 1]);
      }
...
harvest_interfaces__srv__RecordTopics_Request__Sequence__fini(harvest_interfaces__srv__RecordTopics_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      harvest_interfaces__srv__RecordTopics_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  harvest_interfaces__srv__RecordTopics_Request__Sequence * array = (harvest_interfaces__srv__RecordTopics_Request__Sequence *)allocator.allocate(sizeof(harvest_interfaces__srv__RecordTopics_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = harvest_interfaces__srv__RecordTopics_Request__Sequence__init(array, size);
  if (!success) {
...
harvest_interfaces__srv__RecordTopics_Request__Sequence__destroy(harvest_interfaces__srv__RecordTopics_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    harvest_interfaces__srv__RecordTopics_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
harvest_interfaces__srv__RecordTopics_Request__Sequence__are_equal(const harvest_interfaces__srv__RecordTopics_Request__Sequence * lhs, const harvest_interfaces__srv__RecordTopics_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!harvest_interfaces__srv__RecordTopics_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  harvest_interfaces__srv__RecordTopics_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(harvest_interfaces__srv__RecordTopics_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    harvest_interfaces__srv__RecordTopics_Request * data =
      (harvest_interfaces__srv__RecordTopics_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!harvest_interfaces__srv__RecordTopics_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          harvest_interfaces__srv__RecordTopics_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!harvest_interfaces__srv__RecordTopics_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  harvest_interfaces__srv__RecordTopics_Response * msg = (harvest_interfaces__srv__RecordTopics_Response *)allocator.allocate(sizeof(harvest_interfaces__srv__RecordTopics_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(harvest_interfaces__srv__RecordTopics_Response));
  bool success = harvest_interfaces__srv__RecordTopics_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
harvest_interfaces__srv__RecordTopics_Response__destroy(harvest_interfaces__srv__RecordTopics_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    harvest_interfaces__srv__RecordTopics_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
harvest_interfaces__srv__RecordTopics_Response__Sequence__init(harvest_interfaces__srv__RecordTopics_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  harvest_interfaces__srv__RecordTopics_Response * data = NULL;

  if (size) {
    data = (harvest_interfaces__srv__RecordTopics_Response *)allocator.zero_allocate(size, sizeof(harvest_interfaces__srv__RecordTopics_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = harvest_interfaces__srv__RecordTopics_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        harvest_interfaces__srv__RecordTopics_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
harvest_interfaces__srv__RecordTopics_Response__Sequence__fini(harvest_interfaces__srv__RecordTopics_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      harvest_interfaces__srv__RecordTopics_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  harvest_interfaces__srv__RecordTopics_Response__Sequence * array = (harvest_interfaces__srv__RecordTopics_Response__Sequence *)allocator.allocate(sizeof(harvest_interfaces__srv__RecordTopics_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = harvest_interfaces__srv__RecordTopics_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
harvest_interfaces__srv__RecordTopics_Response__Sequence__destroy(harvest_interfaces__srv__RecordTopics_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    harvest_interfaces__srv__RecordTopics_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
harvest_interfaces__srv__RecordTopics_Response__Sequence__are_equal(const harvest_interfaces__srv__RecordTopics_Response__Sequence * lhs, const harvest_interfaces__srv__RecordTopics_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!harvest_interfaces__srv__RecordTopics_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  harvest_interfaces__srv__RecordTopics_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(harvest_interfaces__srv__RecordTopics_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    harvest_interfaces__srv__RecordTopics_Response * data =
      (harvest_interfaces__srv__RecordTopics_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!harvest_interfaces__srv__RecordTopics_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          harvest_interfaces__srv__RecordTopics_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!harvest_interfaces__srv__RecordTopics_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
