...
#include "harvest_interfaces/srv/detail/set_value__rosidl_typesupport_fastrtps_c.h"
...
using _SetValue_Request__ros_msg_type = harvest_interfaces__srv__SetValue_Request;
...
size_t get_serialized_size_harvest_interfaces__srv__SetValue_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetValue_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_harvest_interfaces__srv__SetValue_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_harvest_interfaces
size_t max_serialized_size_harvest_interfaces__srv__SetValue_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = harvest_interfaces__srv__SetValue_Request;
    is_plain =
      (
...
static size_t _SetValue_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_harvest_interfaces__srv__SetValue_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, harvest_interfaces, srv, SetValue_Request)() {
...
using _SetValue_Response__ros_msg_type = harvest_interfaces__srv__SetValue_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_harvest_interfaces
size_t get_serialized_size_harvest_interfaces__srv__SetValue_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetValue_Response__ros_msg_type * ros_message = static_cast<const _SetValue_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_harvest_interfaces__srv__SetValue_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_harvest_interfaces
size_t max_serialized_size_harvest_interfaces__srv__SetValue_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = harvest_interfaces__srv__SetValue_Response;
    is_plain =
      (
...
static size_t _SetValue_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_harvest_interfaces__srv__SetValue_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, harvest_interfaces, srv, SetValue_Response)() {
...
// already included above
// #include "harvest_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "harvest_interfaces/srv/set_value.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, harvest_interfaces, srv, SetValue)() {
