...
#include "harvest_interfaces/srv/detail/set_value__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const harvest_interfaces::srv::SetValue_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  harvest_interfaces::srv::SetValue_Request & ros_message)
{
  // Member: val
  cdr >> ros_message.val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = harvest_interfaces::srv::SetValue_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const harvest_interfaces::srv::SetValue_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<harvest_interfaces::srv::SetValue_Request *>(
    untyped_ros_message);
...
{
  return &harvest_interfaces::srv::typesupport_fastrtps_cpp::_SetValue_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, harvest_interfaces, srv, SetValue_Request)() {
  return &harvest_interfaces::srv::typesupport_fastrtps_cpp::_SetValue_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_harvest_interfaces
cdr_serialize(
  const harvest_interfaces::srv::SetValue_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  harvest_interfaces::srv::SetValue_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = harvest_interfaces::srv::SetValue_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const harvest_interfaces::srv::SetValue_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<harvest_interfaces::srv::SetValue_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &harvest_interfaces::srv::typesupport_fastrtps_cpp::_SetValue_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, harvest_interfaces, srv, SetValue_Response)() {
  return &harvest_interfaces::srv::typesupport_fastrtps_cpp::_SetValue_Response__handle;
}
...
{
  return &harvest_interfaces::srv::typesupport_fastrtps_cpp::_SetValue__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, harvest_interfaces, srv, SetValue)() {
  return &harvest_interfaces::srv::typesupport_fastrtps_cpp::_SetValue__handle;
}
